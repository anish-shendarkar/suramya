            ...
            <div className="flex flex-col h-screen bg-gray-100">
                ...
                <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-6'>
                    <div className="bg-white p-4 rounded-lg shadow hover:shadow-lg transition-shadow">
                        ...
                        <a href="/admin/outfit" className="text-blue-500 hover:underline mt-2 inline-block">Go to Outfits</a>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow hover:shadow-lg transition-shadow">
                        ...
                        <a href="/admin/jewellery" className="text-blue-500 hover:underline mt-2 inline-block">Go to Jewellery</a>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow hover:shadow-lg transition-shadow">
                        <h2 className="text-xl font-semibold mb-2">Manage Accessories</h2>
                        <p className="text-gray-600">Add, edit, or delete accessories.</p>
                        <a href="/admin/accessories" className="text-blue-500 hover:underline mt-2 inline-block">Go to Accessories</a>
                    </div>
                </div>
            </div>
        </div>
